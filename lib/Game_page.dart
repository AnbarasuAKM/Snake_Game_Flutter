...
import 'package:snake_chase/game_over.dart';
...
class _GamePageState extends State<GamePage> with TickerProviderStateMixin {
  ...
  void _setUpGame() {
    ...
    snakeAnimation =
        CurvedAnimation(curve: Curves.bounceInOut, parent: _snakeController);
  }
  ...
  void _updateSnake() {
    if (!_hasStarted) {
      setState(() {
        _playerScore = (_snake.length - 4) * 10;
        ...
        if (_gameOver()) {
          setState(() {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context)=>Game_over(score: _playerScore,)));
          });
        }
      });
    }
